...
; 
; ADDED MVN_KP PREFIX WITHOUT MODIFYING ANY OTHER CODE FOR INCLUSION IN MAVEN 
;   TOOLKIT WITHOUT POSSIBILITY OF CONFLICT WITH ROUTINES ON USER COMPUTERS ALREADY.
;-
