...
function mvn_kp_relative_comp_l2, local, server
  server_out = server
...
pro mvn_kp_download_l2_files, filenames=filenames, list_files=list_files, start_date=start_date, end_date=end_date, $
                              instrument=instrument, mode=mode


;   local_dir=local_dir, insitu=insitu, iuvs=iuvs, new_files=new_files, $
;  text_files=text_files, cdf_files=cdf_files,  $
;  update_prefs=update_prefs,  debug=debug, only_update_prefs=only_update_prefs
...
;    filenames = mvn_kp_relative_comp_l2(local_files, filenames)
;    
;  endif
;  
