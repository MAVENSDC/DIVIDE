...
;-
pro MVN_KP_MAP2D_IUVS_PLOT, iuvs, flag, mso, lat, lon, colors,iuvs_color_table, colorbar, data_exist, minimum, maximum
            ...
            if flag eq 'PERIAPSE' then begin
                  ...
                  if t_ind gt 0 then begin
                    ...
                    MVN_KP_MAP2D_SYMBOL_FILL, temperature, colors, iuvs_color_table, colorbar
