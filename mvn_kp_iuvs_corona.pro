    ...
    if keyword_set(nolegend) eq 0 then begin
     ...
     ;CREATE THE LO-RES LEGEND
        ...
        ;         charthick=1.5, charsize=1.5, /normal
           ...
           leg_i=0.88
           xyouts,0.85,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=2.0,/normal
           for j=0,lo_high_total-1 do begin
              xyouts,0.79,leg_i, time_string(lo_high_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_high_total)
              leg_i=leg_i-0.03
           endfor 
        ...
        ;         charthick=1.5, charsize=1.5, /normal
           ...
           for i=0, n_elements(lo_limb_rad_labels[0,*])-1 do begin
              xyouts,0.09,leg_i,lo_limb_rad_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.07,0.12],[leg_i-0.01,leg_i-0.01], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.03
           ...
           for j=0,lo_limb_total-1 do begin
              xyouts,0.19,leg_i, time_string(lo_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_limb_total)
              leg_i=leg_i-0.03
           endfor 
        endif 
        ...
        ;         charthick=1.5, charsize=1.5, /normal
           ...
           for i=0, n_elements(lo_limb_den_labels[0,*])-1 do begin
              xyouts,0.39,leg_i,lo_limb_den_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.37,0.42],[leg_i-0.01,leg_i-0.01], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.03
           ...
           xyouts,0.55,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=2.0,/normal
           for j=0,lo_limb_total-1 do begin
              xyouts,0.49,leg_i, time_string(lo_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_limb_total)
              leg_i=leg_i-0.03
           endfor 
        ...
        ;         charthick=1.5, charsize=1.5, /normal
           ...
           for i=0, n_elements(lo_limb_scale_labels[0,*])-1 do begin
              xyouts,0.69,leg_i,lo_limb_scale_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.67,0.72],[leg_i-0.01,leg_i-0.01], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.03
           ...
           xyouts,0.85,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=2.0,/normal
           for j=0,lo_limb_total-1 do begin
              xyouts,0.79,leg_i, time_string(lo_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_limb_total)
              leg_i=leg_i-0.03
           endfor 
        ...
        ;         charthick=1.5, charsize=1.5, /normal
           leg_i=0.20
           xyouts,0.05,leg_i+0.03,'Species', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for i=0, n_elements(lo_disk_labels[0,*])-1 do begin
              xyouts,0.04,leg_i,lo_disk_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.02,0.07],[leg_i-0.01,leg_i-0.01], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.03
           endfor
           leg_i=0.20
           xyouts,0.15,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,lo_disk_total-1 do begin
              xyouts,0.10,leg_i, time_string(lo_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_disk_total)
              leg_i=leg_i-0.03
           endfor 
        endif 
              
        if l_d_d eq 1 then begin
        ;xyouts,0.4, 0.93, 'Lo-Res: Dust Depth', alignment=0, $
        ;       charthick=1.5, charsize=1.5, /normal
           leg_i=0.2
           xyouts,0.35,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,lo_disk_total-1 do begin
              xyouts,0.29,leg_i, time_string(lo_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_disk_total)
              leg_i=leg_i-0.03
           endfor 
        ...
        if l_d_a eq 1 then begin
        ; xyouts,0.6, 0.93, 'Lo-Res: Auroral Index', alignment=0, $
        ;        charthick=1.5, charsize=1.5, /normal
           leg_i=0.2
           xyouts,0.60,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,lo_disk_total-1 do begin
              xyouts,0.55,leg_i, time_string(lo_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_disk_total)
              leg_i=leg_i-0.03
           endfor 
        ...
        if l_d_o eq 1 then begin
        ; xyouts,0.8, 0.93, 'Lo-Res: Ozone', alignment=0, $
        ;        charthick=1.5, charsize=1.5, /normal
           leg_i=0.2
           xyouts,0.85,leg_i+.03,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,lo_disk_total-1 do begin
              xyouts,0.79,leg_i, time_string(lo_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/lo_disk_total)
              leg_i=leg_i-0.03
           endfor 
        ...
        device, decompose=0
        plot,[0,0],[1,1], color=255, background=255, /nodata
        xyouts, 0.5, 0.97, 'Echelle  Legend', alignment=0.5, $
                charthick=2.5, charsize=1.5, /normal
        xyouts, 0.08, 0.9, 'High: Radiance', alignment=0.5, $
                charthick=2.0, charsize=1.5, /normal
        xyouts, 0.28, 0.9, 'High: 1/2 Int Dist', alignment=0.5, $
                charthick=2.0, charsize=1.5, /normal
        xyouts, 0.48, 0.9, 'Limb: Radiance', alignment=0.5, $
                charthick=2.0, charsize=1.5, /normal
        xyouts, 0.68, 0.9, 'Limb: 1/2 Int Dist', alignment=0.5, $
                charthick=2.0, charsize=1.5, /normal
        xyouts, 0.88, 0.9, 'Disk: Radiance', alignment=0.5, $
                charthick=2.0, charsize=1.5, /normal
        ...
        ;         charthick=1.5, charsize=1.5, /normal
           leg_i=0.8
           xyouts,0.03,leg_i+0.05,'Species', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for i=0, n_elements(e_high_rad_labels[0,*])-1 do begin
              xyouts,0.01,leg_i,e_high_rad_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.01,0.05],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.07
           endfor
           leg_i=0.8
           xyouts,0.12,leg_i+.05,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,e_high_total-1 do begin
              xyouts,0.05,leg_i-0.02, time_string(e_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_high_total)
              leg_i=leg_i-0.07
           endfor 
        endif 
        ...
        ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
           ; charthick=1.5, charsize=1.5, /normal
           leg_i=0.8
           xyouts,0.23,leg_i+0.05,'Species', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for i=0, n_elements(e_high_half_labels[0,*])-1 do begin
              xyouts,0.21,leg_i,e_high_half_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.21,0.25],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.07
           endfor
           leg_i=0.8
           xyouts,0.32,leg_i+.05,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,e_high_total-1 do begin
              xyouts,0.25,leg_i-0.02, time_string(e_high_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_high_total)
              leg_i=leg_i-0.07
           endfor 
        ...
        ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
           ;charthick=1.5, charsize=1.5, /normal
           leg_i=0.8
           xyouts,0.43,leg_i+0.05,'Species', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for i=0, n_elements(e_limb_rad_labels[0,*])-1 do begin
              xyouts,0.41,leg_i,e_limb_rad_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.41,0.45],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.07
           endfor
           leg_i=0.8
           xyouts,0.52,leg_i+.05,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,e_limb_total-1 do begin
              xyouts,0.45,leg_i-0.02, time_string(e_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_limb_total)
              leg_i=leg_i-0.07
           endfor 
        endif 
        ...
        ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
           ;charthick=1.5, charsize=1.5, /normal
           leg_i=0.8
           xyouts,0.63,leg_i+0.05,'Species', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for i=0, n_elements(e_limb_half_labels[0,*])-1 do begin
              xyouts,0.61,leg_i,e_limb_half_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.61,0.65],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.07
           endfor
           leg_i=0.8
           xyouts,0.72,leg_i+.05,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,e_limb_total-1 do begin
              xyouts,0.65,leg_i-0.02, time_string(e_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_limb_total)
              leg_i=leg_i-0.07
           endfor 
        ...
        ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
           ; charthick=1.5, charsize=1.5, /normal
           leg_i=0.8
           xyouts,0.83,leg_i+0.05,'Species', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for i=0, n_elements(e_disk_labels[0,*])-1 do begin
              xyouts,0.81,leg_i,e_disk_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.81,0.85],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
              leg_i=leg_i-0.07
           endfor
           leg_i=0.8
           xyouts,0.92,leg_i+.05,'Observation', alignment=0.5, $
                  charthick=1.5, charsize=1.5,/normal
           for j=0,e_disk_total-1 do begin
              xyouts,0.85,leg_i, time_string(e_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_disk_total)
              leg_i=leg_i-0.07
           endfor 
        endif 
...
if( (disp_check[0] eq 1) and (disp_check[1] eq 1) and $
    (disp_check[2] eq 1) and (disp_check[3] eq 0) and $
    (disp_check[4] eq 0) and (disp_check[5] eq 0) )then begin
   a=get_screen_size()
   if keyword_set(window) then begin
      window,!window+1,xsize=a[0]*0.5,ysize=a[1]*0.5
   endif else begin
   ...
   if e_d_r eq 1 then begin     ;echelle disk radiance
      plot,e_disk_radiance[0,*],e_disk_timestamp,/nodata,charsize=1.5 ,$
           ystyle=1, title='Echelle Disk: Radiance',$
           xtitle='Time', ytitle='Radiance'
      for i=0, e_disk_total-1 do begin
         oplot,e_disk_radiance[i,*],e_disk_timestamp,linestyle=(i mod 7),$
               color=i*(255/e_disk_total)
      endfor
   ...
   if keyword_set(nolegend) eq 0 then begin
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ;charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.03,leg_i+0.05,'Species', alignment=0.5, charthick=1.5, $
                charsize=1.5,/normal
         for i=0, n_elements(e_high_rad_labels[0,*])-1 do begin
            xyouts,0.01,leg_i,e_high_rad_labels[0,i],alignment=0, $
                   charthick=1.5, charsize=1.5, /normal
     ...
     ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ; charthick=1.5, charsize=1.5, /normal
         ...
         xyouts,0.83,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for i=0, n_elements(lo_limb_scale_labels[0,*])-1 do begin
            xyouts,0.81,leg_i,lo_limb_scale_labels[0,i],alignment=0, $
                   charthick=1.5, charsize=1.5, /normal
            plots,[0.81,0.85],[leg_i-0.02,leg_i-0.02], $
                  linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
         ...
         xyouts,0.92,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for j=0,lo_limb_total-1 do begin
            xyouts,0.85,leg_i-0.02, time_string(lo_limb_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/lo_limb_total)
            leg_i=leg_i-0.07
         endfor 
...
if( (disp_check[3] eq 1) and (disp_check[4] eq 1) and $
    (disp_check[5] eq 1) and (disp_check[0] eq 0) and $
    (disp_check[1] eq 0) and (disp_check[2] eq 0) )then begin
  a=get_screen_size()
  if keyword_set(window) then begin
     window,!window+1,xsize=a[0]*0.5,ysize=a[1]*0.9
  endif else begin
  ...
  if l_d_r eq 1 then begin        ;lores disk radiance
    plot,lo_disk_radiance[0,*],lo_disk_timestamp,/nodata,$
         charsize=1.5,ystyle=1,title='Lo_Res Disk: Radiance',$
         xtitle='Time', ytitle='Radiance'
    for i=0, lo_disk_total-1 do begin
      oplot,lo_disk_radiance[i,*],lo_disk_timestamp,$
            linestyle=(i mod 7),color=i*(255/lo_disk_total)
    endfor    
  endif
  ...
  if l_l_d eq 1 then begin        ;lores limb density
   ...
   if l_d_d eq 1 then begin        ;lores disk density
    plot,lo_disk_dust[0,*],lo_disk_timestamp,/nodata,charsize=1.5,$
         ystyle=1,title='Lo_Res Disk: Dust Depth',$
         xtitle='Time', ytitle='Dust Depth'
    for i=0, lo_disk_total-1 do begin
      oplot,lo_disk_dust[i,*],lo_disk_timestamp,linestyle=(i mod 7),$
            color=i*(255/lo_disk_total)
    endfor       
  ...
  if l_d_a eq 1 then begin        ;lores disk aurora
    plot,lo_disk_auroral[0,*],lo_disk_timestamp,/nodata,charsize=1.5,$
         ystyle=1,title='Lo_Res Disk: Auroral Index',$
         xtitle='Time', ytitle='Auroral Index'
    for i=0, lo_disk_total-1 do begin
      oplot,lo_disk_auroral[i,*],lo_disk_timestamp,$
            linestyle=(i mod 7),color=i*(255/lo_disk_total)
    endfor      
  endif
  ...
  if l_d_o eq 1 then begin        ;lores disk ozone
    plot,lo_disk_ozone[0,*],lo_disk_timestamp,/nodata,charsize=1.5,$
         ystyle=1,title='Lo_Res Disk: Ozone Depth',$
         xtitle='Time', ytitle='Ozone Depth'
    for i=0, lo_disk_total-1 do begin
      oplot,lo_disk_ozone[i,*],lo_disk_timestamp,linestyle=(i mod 7),$
            color=i*(255/lo_disk_total)
    endfor     
  ...
  if keyword_set(nolegend) eq 0 then begin
     ...
     if l_h_r eq 1 then begin
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        for i=0, n_elements(lo_high_rad_labels[0,*])-1 do begin
           xyouts,0.09,leg_i,lo_high_rad_labels[0,i],alignment=0, $
                  charthick=1.5, charsize=1.5, /normal
           plots,[0.07,0.12],[leg_i-0.01,leg_i-0.01], linestyle=(i mod 7), $
                 thick=2, /normal
           leg_i=leg_i-0.03
        endfor
        leg_i=0.88
     ...
     if l_h_d eq 1 then begin
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ; charthick=1.5, charsize=1.5, /normal
        leg_i=0.88
        xyouts,0.4,leg_i+0.03,'Species', alignment=0.5, charthick=1.5, $
               charsize=2.0,/normal
        for i=0, n_elements(lo_high_den_labels[0,*])-1 do begin
           xyouts,0.39,leg_i,lo_high_den_labels[0,i],alignment=0, $
                  charthick=1.5, charsize=1.5, /normal
           plots,[0.37,0.42],[leg_i-0.01,leg_i-0.01], linestyle=(i mod 7), $
                 thick=2, /normal
           leg_i=leg_i-0.03
        endfor
        leg_i=0.88
        xyouts,0.55,leg_i+.03,'Observation', alignment=0.5, charthick=1.5, $
               charsize=2.0,/normal
        for j=0,lo_high_total-1 do begin
           xyouts,0.49,leg_i, time_string(lo_high_timestamp[j]), $
                  alignment=0, charthick=1, charsize=1, /normal,$
...
if( (disp_check[0] eq 1) and (disp_check[3] eq 1) and $
   ...
   if e_d_r eq 1 then begin     ;echelle disk radiance
      plot,e_disk_radiance[0,*],e_disk_timestamp,/nodata,$
           charsize=1.5 ,ystyle=1, title='Echelle Disk: Radiance',$
           xtitle='Time', ytitle='Radiance'
      for i=0, e_disk_total-1 do begin
         oplot,e_disk_radiance[i,*],e_disk_timestamp,$
               linestyle=(i mod 7),color=i*(255/e_disk_total)
      endfor
   endif
   ...
   if l_d_d eq 1 then begin     ;lores disk density
      plot,lo_disk_dust[0,*],lo_disk_timestamp,/nodata,charsize=1.5,$
           ...
           xtitle='Time', ytitle='Dust Depth'
      for i=0, lo_disk_total-1 do begin
         oplot,lo_disk_dust[i,*],lo_disk_timestamp,$
               linestyle=(i mod 7),color=i*(255/lo_disk_total)
      endfor       
   endif
              
   if l_d_a eq 1 then begin     ;lores disk aurora
      plot,lo_disk_auroral[0,*],lo_disk_timestamp,/nodata,$
           charsize=1.5,ystyle=1,title='Lo_Res Disk: Auroral Index',$
           xtitle='Time', ytitle='Auroral Index'
      for i=0, lo_disk_total-1 do begin
         oplot,lo_disk_auroral[i,*],lo_disk_timestamp,$
               linestyle=(i mod 7),color=i*(255/lo_disk_total)
   ...
   if l_d_o eq 1 then begin     ;lores disk ozone
      plot,lo_disk_ozone[0,*],lo_disk_timestamp,/nodata,$
           charsize=1.5,ystyle=1,title='Lo_Res Disk: Ozone Depth',$
           xtitle='Time', ytitle='Ozone Depth'
      for i=0, lo_disk_total-1 do begin
         oplot,lo_disk_ozone[i,*],lo_disk_timestamp,$
               linestyle=(i mod 7),color=i*(255/lo_disk_total)
      endfor     
   endif
   ...
   if keyword_set(nolegend) eq 0 then begin
      ...
      device,decomposed=0
      plot,[0,0],[1,1], color=255, background=255, /nodata
      xyouts, 0.5, 0.97, 'Echelle/Lo-Res Disk Legend', $
              alignment=0.5, charthick=2.5, charsize=2.0, /normal
      xyouts, 0.10, 0.9, 'E: Radiance', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.30, 0.9, 'Lo: Radiance', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.50, 0.9, 'Lo: Dust Depth', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.70, 0.9, 'Lo: Auroral Index', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.90, 0.9, 'Lo: Ozone Index', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.05,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for i=0, n_elements(e_disk_labels[0,*])-1 do begin
            xyouts,0.04,leg_i,e_disk_labels[0,i],alignment=0, $
                   charthick=1.5, charsize=1.5, /normal
            plots,[0.02,0.07],[leg_i-0.02,leg_i-0.02], $
                  linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
         endfor
         leg_i=0.8
         xyouts,0.15,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for j=0,e_disk_total-1 do begin
            xyouts,0.10,leg_i, time_string(e_disk_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/e_disk_total)
            leg_i=leg_i-0.07
         endfor 
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.25,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for i=0, n_elements(lo_disk_labels[0,*])-1 do begin
            xyouts,0.24,leg_i,lo_disk_labels[0,i],alignment=0, $
                   charthick=1.5, charsize=1.5, /normal
            plots,[0.22,0.27],[leg_i-0.02,leg_i-0.02], $
                  linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
         endfor
         leg_i=0.8
         xyouts,0.35,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for j=0,lo_disk_total-1 do begin
            xyouts,0.30,leg_i, time_string(lo_disk_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/lo_disk_total)
            leg_i=leg_i-0.07
         endfor 
      ...
      ;xyouts,0.4, 0.93, 'Lo-Res: Dust Depth', alignment=0, $
        ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.5,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for j=0,lo_disk_total-1 do begin
            xyouts,0.44,leg_i, time_string(lo_disk_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/lo_disk_total)
            leg_i=leg_i-0.07
         endfor 
      ...
      ; xyouts,0.6, 0.93, 'Lo-Res: Auroral Index', alignment=0, $
         ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.70,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for j=0,lo_disk_total-1 do begin
            xyouts,0.64,leg_i, time_string(lo_disk_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/lo_disk_total)
            leg_i=leg_i-0.07
         endfor 
      ...
      if l_d_o eq 1 then begin
         ; xyouts,0.8, 0.93, 'Lo-Res: Ozone', $
         ; alignment=0, charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.9,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
         for j=0,lo_disk_total-1 do begin
            xyouts,0.84,leg_i, time_string(lo_disk_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/lo_disk_total)
            leg_i=leg_i-0.07
         endfor 
...
if( (disp_check[1] eq 1) and (disp_check[4] eq 1) and $
    (disp_check[0] eq 0) and (disp_check[2] eq 0) and $
    (disp_check[3] eq 0) and (disp_check[5] eq 0) )then begin
   a=get_screen_size()
   if keyword_set(window) then begin
      window,!window+1,xsize=a[0]*0.5,ysize=a[1]*0.5
   endif else begin
   ...
   if keyword_set(nolegend) eq 0 then begin
     ...
     xyouts, 0.5, 0.97, 'Echelle/Lo-Res High Altitude Legend', $
             alignment=0.5, charthick=2.5, charsize=1.5, /normal
     xyouts, 0.08, 0.9, 'E: Radiance', alignment=0.5, $
             charthick=2.0, charsize=2.0, /normal
     xyouts, 0.28, 0.9, 'E: 1/2 Int Dist', alignment=0.5, $
             charthick=2.0, charsize=2.0, /normal
     xyouts, 0.48, 0.9, 'Lo: Radiance', alignment=0.5, $
             charthick=2.0, charsize=2.0, /normal
     xyouts, 0.68, 0.9, 'Lo: Density', alignment=0.5, $
             charthick=2.0, charsize=2.0, /normal
     xyouts, 0.88, 0.9, 'Lo: Scale Height', alignment=0.5, $
             charthick=2.0, charsize=2.0, /normal
     ...
     if e_l_r eq 1 then begin
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        xyouts,0.03,leg_i+0.05,'Species', alignment=0.5, $
               charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(e_limb_rad_labels[0,*])-1 do begin
             xyouts,0.01,leg_i,e_limb_rad_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.01,0.05],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        leg_i=0.8
         xyouts,0.23,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(e_limb_half_labels[0,*])-1 do begin
             xyouts,0.21,leg_i,e_limb_half_labels[0,i],$
                    alignment=0, charthick=1.5, charsize=1.5, /normal
             plots,[0.21,0.25],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
         ...
         xyouts,0.32,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,e_limb_total-1 do begin
             xyouts,0.25,leg_i-0.02, time_string(e_limb_timestamp[j]),$
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/e_limb_total)
             leg_i=leg_i-0.07
         endfor 
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        leg_i=0.8
         xyouts,0.43,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(lo_limb_rad_labels[0,*])-1 do begin
             xyouts,0.41,leg_i,lo_limb_rad_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.41,0.45],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
         ...
         xyouts,0.52,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,lo_limb_total-1 do begin
             xyouts,0.45,leg_i-0.02, time_string(lo_limb_timestamp[j]), $
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/lo_limb_total)
             leg_i=leg_i-0.07
         endfor 
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        leg_i=0.8
         xyouts,0.63,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(lo_limb_den_labels[0,*])-1 do begin
             xyouts,0.61,leg_i,lo_limb_den_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.61,0.65],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
         ...
         xyouts,0.72,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,lo_limb_total-1 do begin
             xyouts,0.65,leg_i-0.02, time_string(lo_limb_timestamp[j]), $
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/lo_limb_total)
             leg_i=leg_i-0.07
         endfor 
...
if( (disp_check[2] eq 1) and (disp_check[5] eq 1) and $
    (disp_check[0] eq 0) and (disp_check[1] eq 0) and $
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        for i=0, n_elements(e_high_rad_labels[0,*])-1 do begin
         ...
         xyouts,0.12,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,e_high_total-1 do begin
             xyouts,0.05,leg_i-0.02, time_string(e_high_timestamp[j]), $
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/e_high_total)
             leg_i=leg_i-0.07
         endfor 
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        leg_i=0.8
         xyouts,0.43,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(lo_high_rad_labels[0,*])-1 do begin
             xyouts,0.41,leg_i,lo_high_rad_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.41,0.45],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
         ...
         xyouts,0.52,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,lo_high_total-1 do begin
             xyouts,0.45,leg_i-0.02, time_string(lo_high_timestamp[j]), $
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/lo_high_total)
             leg_i=leg_i-0.07
         endfor 
     ...
     if l_h_d eq 1 then begin
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        xyouts,0.63,leg_i+0.05,'Species', alignment=0.5, $
               charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(lo_high_den_labels[0,*])-1 do begin
             xyouts,0.61,leg_i,lo_high_den_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.61,0.65],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
         ...
         xyouts,0.72,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,lo_high_total-1 do begin
             xyouts,0.65,leg_i-0.02, time_string(lo_high_timestamp[j]), $
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/lo_high_total)
             leg_i=leg_i-0.07
         endfor 
      ...
      ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
        ...
        leg_i=0.8
         xyouts,0.83,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for i=0, n_elements(lo_high_half_labels[0,*])-1 do begin
             xyouts,0.81,leg_i,lo_high_half_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.81,0.85],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
           leg_i=leg_i-0.07
         ...
         xyouts,0.92,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
        for j=0,lo_high_total-1 do begin
             xyouts,0.85,leg_i-0.02, time_string(lo_high_timestamp[j]), $
                    alignment=0, charthick=1, charsize=1, /normal,$
                    color=j*(255/lo_high_total)
             leg_i=leg_i-0.07
         endfor 
...
if( (disp_check[0] eq 1) and (disp_check[1] eq 0) and $
    (disp_check[2] eq 0) and (disp_check[3] eq 0) and $
    (disp_check[4] eq 0) and (disp_check[5] eq 0) )then begin
   a=get_screen_size()
   if keyword_set(window) then begin
      window,!window+1,xsize=a[0]*0.5,ysize=a[1]*0.5
   ...
   if keyword_set(nolegend) eq 0 then begin
      ...
      xyouts, 0.5, 0.97, 'Echelle Disk Legend', alignment=0.5, $
              charthick=2.5, charsize=2.0, /normal

      xyouts, 0.15, 0.9, 'Radiance', alignment=0.5, charthick=2.0, $
              charsize=2.0, /normal
      ...
      if e_d_r eq 1 then begin
         ...
         ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.10,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=2.0,/normal
         for i=0, n_elements(e_disk_labels[0,*])-1 do begin
            xyouts,0.09,leg_i,e_disk_labels[0,i],alignment=0, $
                   charthick=1.5, charsize=1.5, /normal
            plots,[0.07,0.12],[leg_i-0.02,leg_i-0.02], $
                  linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
         endfor
         leg_i=0.8
         xyouts,0.25,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=2.0,/normal
         for j=0,e_disk_total-1 do begin
            xyouts,0.19,leg_i, time_string(e_disk_timestamp[j]), $
                   alignment=0, charthick=1, charsize=1, /normal,$
                   color=j*(255/e_disk_total)
            leg_i=leg_i-0.07
         endfor 
...
if( (disp_check[1] eq 1) and (disp_check[0] eq 0) and $
    (disp_check[2] eq 0) and (disp_check[3] eq 0) and $
    (disp_check[4] eq 0) and (disp_check[5] eq 0) )then begin
    a=get_screen_size()
    if keyword_set(window) then begin
    ...
    if keyword_set(nolegend) eq 0 then begin
      ...
      xyouts, 0.5, 0.97, 'Echelle Limb Profile Legend', $
              alignment=0.5, charthick=2.5, charsize=2.0, /normal
      xyouts, 0.15, 0.9, 'Radiance', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.5, 0.9, '1/2 Int Dist', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      ...
      if e_l_r eq 1 then begin
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ...
         xyouts,0.10,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=2.0,/normal
         for i=0, n_elements(e_limb_rad_labels[0,*])-1 do begin
              xyouts,0.09,leg_i,e_limb_rad_labels[0,i],alignment=0,$
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.07,0.12],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
          ...
          xyouts,0.25,leg_i+.05,'Observation', alignment=0.5, $
                 charthick=1.5, charsize=2.0,/normal
         for j=0,e_limb_total-1 do begin
              xyouts,0.19,leg_i, time_string(e_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_limb_total)
              leg_i=leg_i-0.07
          endfor 
      ...
      if e_l_h eq 1 then begin
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
          xyouts,0.4,leg_i+0.05,'Species', alignment=0.5, $
                 charthick=1.5, charsize=2.0,/normal
         for i=0, n_elements(e_limb_half_labels[0,*])-1 do begin
              xyouts,0.39,leg_i,e_limb_half_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.37,0.42],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
        endfor
          leg_i=0.8
          xyouts,0.55,leg_i+.05,'Observation', alignment=0.5, $
                 charthick=1.5, charsize=2.0,/normal
         for j=0,e_limb_total-1 do begin
              xyouts,0.49,leg_i, time_string(e_limb_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_limb_total)
              leg_i=leg_i-0.07
          endfor 
...
if( (disp_check[2] eq 1) and (disp_check[0] eq 0) and $
    (disp_check[1] eq 0) and (disp_check[3] eq 0) and $
    (disp_check[4] eq 0) and (disp_check[5] eq 0) )then begin
    a=get_screen_size()
    if keyword_set(window) then begin
       window,!window+1,xsize=a[0]*0.5,ysize=a[1]*0.5
    ...
    if keyword_set(nolegend) eq 0 then begin
      ...
      xyouts, 0.5, 0.97, 'Echelle High Altitude Legend', $
              alignment=0.5, charthick=2.5, charsize=2.0, /normal
      xyouts, 0.15, 0.9, 'Radiance', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.5, 0.9, '1/2 Int Dist', alignment=0.5, $
      ...
      if e_h_r eq 1 then begin
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ...
         xyouts,0.10,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=2.0,/normal
         for i=0, n_elements(e_high_rad_labels[0,*])-1 do begin
              xyouts,0.09,leg_i,e_high_rad_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.07,0.12],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
          ...
          xyouts,0.25,leg_i+.05,'Observation', alignment=0.5, $
                 charthick=1.5, charsize=2.0,/normal
         for j=0,e_high_total-1 do begin
              xyouts,0.19,leg_i, time_string(e_high_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_high_total)
              leg_i=leg_i-0.07
          endfor 
      ...
      if e_h_h eq 1 then begin
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
         ...
         xyouts,0.4,leg_i+0.05,'Species', alignment=0.5, $
                charthick=1.5, charsize=2.0,/normal
         for i=0, n_elements(e_high_half_labels[0,*])-1 do begin
              xyouts,0.39,leg_i,e_high_half_labels[0,i],alignment=0, $
                     charthick=1.5, charsize=1.5, /normal
              plots,[0.37,0.42],[leg_i-0.02,leg_i-0.02], $
                    linestyle=(i mod 7), thick=2, /normal
            leg_i=leg_i-0.07
          ...
          xyouts,0.55,leg_i+.05,'Observation', alignment=0.5, $
                 charthick=1.5, charsize=2.0,/normal
         for j=0,e_high_total-1 do begin
              xyouts,0.49,leg_i, time_string(e_high_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
                     color=j*(255/e_high_total)
              leg_i=leg_i-0.07
          endfor 
...
if( (disp_check[3] eq 1) and (disp_check[0] eq 0) and $
    (disp_check[1] eq 0) and (disp_check[2] eq 0) and $
    (disp_check[4] eq 0) and (disp_check[5] eq 0) )then begin
    a=get_screen_size()
    if keyword_set(window) then begin
    ...
    if l_d_d eq 1 then begin        ;lores disk density
      plot,lo_disk_dust[0,*],lo_disk_timestamp,/nodata,$
           charsize=1.5,ystyle=1,title='Lo_Res Disk: Dust Depth',$
           xtitle='Time', ytitle='Dust Depth'
      for i=0, lo_disk_total-1 do begin
        oplot,lo_disk_dust[i,*],lo_disk_timestamp,$
              linestyle=(i mod 7),color=i*(255/lo_disk_total)
    ...
    if keyword_set(nolegend) eq 0 then begin
      ...
      xyouts, 0.5, 0.97, 'Lo-Res Disk Legend', alignment=0.5, $
              charthick=2.5, charsize=2.0, /normal
      xyouts, 0.10, 0.9, 'Radiance', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.35, 0.9, 'Dust Depth', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.60, 0.9, 'Auroral Index', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.85, 0.9, 'Ozone Index', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      ...
      if l_d_d eq 1 then begin
       ...
       if l_d_a eq 1 then begin
        ; xyouts,0.6, 0.93, 'Lo-Res: Auroral Index', alignment=0, $
          ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.60,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
           for j=0,lo_disk_total-1 do begin
              xyouts,0.55,leg_i, time_string(lo_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
      ...
      if l_d_o eq 1 then begin
        ; xyouts,0.8, 0.93, 'Lo-Res: Ozone', alignment=0, $
         ; charthick=1.5, charsize=1.5, /normal
         leg_i=0.8
         xyouts,0.85,leg_i+.05,'Observation', alignment=0.5, $
                charthick=1.5, charsize=1.5,/normal
           for j=0,lo_disk_total-1 do begin
              xyouts,0.79,leg_i, time_string(lo_disk_timestamp[j]), $
                     alignment=0, charthick=1, charsize=1, /normal,$
...
if( (disp_check[4] eq 1) and (disp_check[0] eq 0) and $
    (disp_check[1] eq 0) and (disp_check[2] eq 0) and $
    (disp_check[3] eq 0) and (disp_check[5] eq 0) )then begin
    a=get_screen_size()
    if keyword_set(window) then begin
    ...
    if keyword_set(nolegend) eq 0 then begin
       ...
       device,decomposed=0
       plot,[0,0],[1,1], color=255, background=255, /nodata
       xyouts, 0.5, 0.97, 'Lo-Res Limb Profile Legend', $
               alignment=0.5, charthick=2.5, charsize=2.0, /normal
       xyouts, 0.15, 0.9, 'Radiance', alignment=0.5, $
               charthick=2.0, charsize=2.0, /normal
       xyouts, 0.5, 0.9, 'Density', alignment=0.5, charthick=2.0, $
               charsize=2.0, /normal
       xyouts, 0.8, 0.9, 'Scale Height', alignment=0.5, charthick=2.0, $
               charsize=2.0, /normal
       ...
       ;  xyouts,0.4, 0.93, 'Lo-Res: Radiance', alignment=0, $
          ; charthick=1.5, charsize=1.5, /normal
          leg_i=0.8
          xyouts,0.7,leg_i+0.05,'Species', alignment=0.5, $
                 charthick=1.5, charsize=2.0,/normal
          for i=0, n_elements(lo_limb_scale_labels[0,*])-1 do begin
             xyouts,0.69,leg_i,lo_limb_scale_labels[0,i],alignment=0, $
                    charthick=1.5, charsize=1.5, /normal
             plots,[0.67,0.72],[leg_i-0.02,leg_i-0.02], $
                   linestyle=(i mod 7), thick=2, /normal
             leg_i=leg_i-0.07
          endfor
          leg_i=0.8
...
if( (disp_check[5] eq 1) and (disp_check[0] eq 0) and $
    ...
    if keyword_set(nolegend) eq 0 then begin              
      ...
      xyouts, 0.5, 0.97, 'Lo-Res High Altitude Legend', $
              alignment=0.5, charthick=2.5, charsize=2.0, /normal
      xyouts, 0.15, 0.9, 'Radiance', alignment=0.5, $
              charthick=2.0, charsize=2.0, /normal
      xyouts, 0.5, 0.9, 'Density', alignment=0.5, charthick=2.0, $
              charsize=2.0, /normal
      xyouts, 0.8, 0.9, '1/2 Int Dist', alignment=0.5, charthick=2.0, $
              charsize=2.0, /normal
