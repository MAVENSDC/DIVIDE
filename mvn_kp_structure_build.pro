...
;DEFINE THE ALWAYS INCLUDED STRUCTURES OF SPACECRAFT AND APP PARAMETERS 
 ...
 record_temp1 = create_struct(['spacecraft','app'],s1,s2)
  ...
  if instrument_array[7] eq 1 then begin    ;INCLUDE IUVS PERIAPSE DATA STRUCTURE
    i1 = {periapse,time_start:'', time_stop:'', scale_height:fltarr(7), scale_height_err:fltarr(7), density:fltarr(7,30), density_err:fltarr(7,30),$
                   radiance:fltarr(10,30), radiance_err:fltarr(10,30), temperature:0.0, temperature_err:0.0, sza:0.0,$
                   local_time:0.0, lat:0.0, lon:0.0, lat_mso:0.0, lon_mso:0.0, mars_season_ls:0.0, spacecraft_geo:dblarr(3),$
                   ...
                   subsolar_point_geo_longitude:0.0, subsolar_point_geo_latitude:0.0, subsolar_point_mso_longitude:0.0,$
                   subsolar_point_mso_latitude:0.0, spacecraft_sza:0.0, spacecraft_local_time:0.0, spacecraft_altitude:0.0,$
  ...
  if instrument_array[8] eq 1 then begin    ;INCLUDE IUVS APOAPSE DATA STRUCTURE
    i2 = {apoapse, time_start:'', time_stop:'', ozone_depth:fltarr(90,45), ozone_depth_err:fltarr(90,45), auroral_index:fltarr(90,45), dust_depth:fltarr(90,45), $
                   dust_depth_err:fltarr(90,45), radiance:fltarr(4,90,45), radiance_err:fltarr(4,90,45), sza_bp:fltarr(90,45), $
                   local_time_bp:fltarr(90,45), sza:0.0,$
                   local_time:0.0, lat:0.0, lon:0.0, lat_mso:0.0, lon_mso:0.0, mars_season_ls:0.0, spacecraft_geo:dblarr(3),$
                   spacecraft_mso:dblarr(3), sun_geo:dblarr(3), sun_mso:dblarr(3), spacecraft_geo_longitude:0.0,$
                   spacecraft_geo_latitude:0.0, spacecraft_mso_longitude:0.0, spacecraft_mso_latitude:0.0,$
                   subsolar_point_geo_longitude:0.0, subsolar_point_geo_latitude:0.0, subsolar_point_mso_longitude:0.0,$
  ...
  endelse
  if instrument_array[9] eq 1 then begin    ;INCLUDE IUVS HIGH ALTITUDE CORONA DATA STRUCTURE
    i3 = {c_e_high, time_start:'', time_stop:'', half_int_distance:fltarr(3), half_int_distance_err:fltarr(3), radiance:fltarr(3,80), radiance_err:fltarr(3,80), sza:0.0,$
                   local_time:0.0, lat:0.0, lon:0.0, lat_mso:0.0, lon_mso:0.0, mars_season_ls:0.0, spacecraft_geo:dblarr(3),$
                   spacecraft_mso:dblarr(3), sun_geo:dblarr(3), sun_mso:dblarr(3), spacecraft_geo_longitude:0.0,$
                   spacecraft_geo_latitude:0.0, spacecraft_mso_longitude:0.0, spacecraft_mso_latitude:0.0,$
                   subsolar_point_geo_longitude:0.0, subsolar_point_geo_latitude:0.0, subsolar_point_mso_longitude:0.0,$
  ...
  endelse
  if instrument_array[10] eq 1 then begin    ;INCLUDE IUVS DISK CORONA DATA STRUCTURE
    i4 = {c_e_disk, time_start:'', time_stop:'', radiance:fltarr(3), radiance_err:fltarr(3), sza:0.0,$
                   local_time:0.0, lat:0.0, lon:0.0, lat_mso:0.0, lon_mso:0.0, mars_season_ls:0.0, spacecraft_geo:dblarr(3),$
                   spacecraft_mso:dblarr(3), sun_geo:dblarr(3), sun_mso:dblarr(3), spacecraft_geo_longitude:0.0,$
                   spacecraft_geo_latitude:0.0, spacecraft_mso_longitude:0.0, spacecraft_mso_latitude:0.0,$
                   subsolar_point_geo_longitude:0.0, subsolar_point_geo_latitude:0.0, subsolar_point_mso_longitude:0.0,$
                   subsolar_point_mso_latitude:0.0, spacecraft_sza:0.0, spacecraft_local_time:0.0, spacecraft_altitude:0.0,$
                   mars_sun_distance:0.0}
    iuvs_record_temp4 = create_struct(['corona_e_disk'],i4,iuvs_record_temp3)
  endif else begin
  ...
  if instrument_array[12] eq 1 then begin     ;INCLUDE IUVS LO RES HIGH ALITUDE CORONA DATA STRUCTURE
    i6 = {c_l_high, time_start:'', time_stop:'', scale_height:fltarr(7), scale_height_err:fltarr(7), density:fltarr(7,30), $
                    density_err:fltarr(7,30), radiance:fltarr(10,30), radiance_err:fltarr(10,30), temperature:0.0, temperature_err:0.0, $
                    sza:0.0, local_time:0.0, lat:0.0, lon:0.0, lat_mso:0.0, lon_mso:0.0, mars_season_ls:0.0, spacecraft_geo:dblarr(3),$
                    spacecraft_mso:dblarr(3), sun_geo:dblarr(3), sun_mso:dblarr(3), spacecraft_geo_longitude:0.0,$
                    spacecraft_geo_latitude:0.0, spacecraft_mso_longitude:0.0, spacecraft_mso_latitude:0.0,$
                    subsolar_point_geo_longitude:0.0, subsolar_point_geo_latitude:0.0, subsolar_point_mso_longitude:0.0,$
                    subsolar_point_mso_latitude:0.0, spacecraft_sza:0.0, spacecraft_local_time:0.0, spacecraft_altitude:0.0,$
  ...
  if instrument_array[13] eq 1 then begin     ;INCLUDE IUVS LO RES LIMB CORONA DATA STRUCTURE
    i7 = {c_l_limb, time_start:'', time_stop:'', scale_height:fltarr(7), scale_height_err:fltarr(7), density:fltarr(7,30), $
                    density_err:fltarr(7,30), radiance:fltarr(10,30), radiance_err:fltarr(10,30), temperature:0.0, temperature_err:0.0, $
                    sza:0.0, local_time:0.0, lat:0.0, lon:0.0, lat_mso:0.0, lon_mso:0.0, mars_season_ls:0.0, spacecraft_geo:dblarr(3),$
                    spacecraft_mso:dblarr(3), sun_geo:dblarr(3), sun_mso:dblarr(3), spacecraft_geo_longitude:0.0,$
                    spacecraft_geo_latitude:0.0, spacecraft_mso_longitude:0.0, spacecraft_mso_latitude:0.0,$
  ...
  iuvs_record = 0
  iuvs_record = create_struct(iuvs_record_temp7)
